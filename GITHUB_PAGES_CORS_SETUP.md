...
При публикации на GitHub Pages возникают CORS ошибки, так как API сервер `https://db.acoustic.ru:3005` не разрешает запросы с домена `https://lvp0110.github.io`.
...
Если у вас есть доступ к серверу `https://db.acoustic.ru:3005`, попросите администратора добавить домен `https://lvp0110.github.io` в список разрешенных источников.
