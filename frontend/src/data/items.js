...
const ItemsBase = [
  ...
  {
    id: 504,
    title: "Шуманет-Термо ЭКО",
    description:
      "Шуманет-Термо ЭКО – высокоэффективный звукопоглощающий мат из акустического наполнителя Шуманет ЭКО в специальной мембране из нетканого полотна.",
    c_id: "C",
    template: 5,
    ag_id: "AG.Ct_eco",
    weight: "-",
