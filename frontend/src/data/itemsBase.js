/** Статический каталог конструкций (title/description для UI и таблиц). */
export const ItemsBase = [
  ...
  {
    id: 406,
    title: "Облицовка с применением Ультракустик",
    description:
      "Облицовка на каркасе ПП 60/27 с применением креплений Ультракустик",
    c_id: "L",
    template: 101,
    ag_id: "AG.L404_ul",
    weight: "35,8 кг/м2",
  ...
  {
    id: 506,
    title: "Потолок на креплениях Ультракустик",
    description:
      "Подвесной потолок, смонтированный на креплениях Ультракустик",
    c_id: "C",
    template: 5,
    ag_id: "AG.C501_ul",
    weight: "37 кг/м2",
  ...
  {
    id: 505,
    title: "Ультракустик Супер Мат",
    description:
      "Ультракустик Супер Мат предназначен для использования в качестве звукопоглощающего слоя в конструкциях",
    c_id: "C",
    template: 5,
    ag_id: "AG.Cs_mat",
    weight: "-",
