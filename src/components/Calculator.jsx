...
const Calculator = () => {
  ...
  const getActiveCategories = useMemo(() => {
    if (currentCategory != 0) {
      return Categories.filter((el) => el.id == currentCategory);
    }
    return Categories;
  }, [currentCategory]);
  ...
  const getSubCategories = useMemo(() => {
    if (currentCategory != 0) {
      ...
      return SubCategories.filter((el) => el.c_id == currentCategory);
    }
    return [];
  ...
  const setConstrFromCalcToSent = () => {
    ...
    if ((code == 'AG.F615' || code == 'AG.F615_vibroflex_LD') && profileStep == 600) {
  ...
  const checkInput = () => {
    ...
    if (currentSubCategory == 'W') {
      objectX = SizeLimits.find(el => el.id_constr == currentItems && el.step == profileStep);
      if (!objectX) return null;
      max_constr_size = objectX.max_lenZ;

      if (isNaN(+constR.lenX) || +constR.lenX < 100) return '<span class="p1">Введите правильную ширину</span> <br> Минимальная ШИРИНА конструкции 100 мм';
      else if (+constR.lenX > 50000) return '<span class="p1">Введите правильную ширину</span> <br> В конструкциях ШИРИНОЙ свыше 15 метров необходимо устраивать температурные(деформационные) швы';
      else if (isNaN(+constR.lenZ) || +constR.lenZ < 100) return '<span class="p1">Введите правильную высоту</span> <br> Минимальная ВЫСОТА конструкции 100 мм';
      else if (+constR.lenZ > max_constr_size) return '<span class="p1">Введите правильную высоту</span> <br>Максимальная ВЫСОТА конструкции указана в меню выбора шага профиля';
    }
      ...
      if (isNaN(+constR.lenX) || +constR.lenX < 200) return '<span class="p1">Введите правильную ширину</span> <br>Минимальный размер обрезанной панели ЗИПС,пригодной к монтажу,составляет 200 мм.На обрезанном фрагменте должны присутствовать минимум 2 виброузла и 2 регулиремые опоры для панелей ЗИПС-Z4';
      else if (+constR.lenX > 50000) return '<span class="p1">Введите правильную ширину</span> <br>В конструкциях ШИРИНОЙ свыше 15 метров необходимо устраивать температурные(деформационные) швы';
      else if (isNaN(+constR.lenZ) || +constR.lenZ < 200) return '<span class="p1">Введите правильную высоту</span> <br>Минимальный размер обрезанной панели ЗИПС,пригодной к монтажу,составляет 200 мм.На обрезанном фрагменте должны присутствовать минимум 2 виброузла и 2 регулиремые опоры для панелей ЗИПС-Z4';
      else if (+constR.lenZ > max_constr_size) return '<span class="p1">Введите правильную высоту</span> <br>При монтаже панельной системы ЗИПС на ВЫСОТУ более 6 м рекомендуется устраивать деформационный шов  ';
    }
    else if (currentSubCategory == 'C' && template == 5) {
      if (isNaN(+constR.lenX) || +constR.lenX < 250) return '<span class="p1">Введите правильную ширину</span> <br>Минимальная ШИРИНА конструкции 250 мм';
      else if (+constR.lenX > 50000) return '<span class="p1">Введите правильную ширину</span> <br>В конструкциях ШИРИНОЙ свыше 15 метров необходимо устраивать температурные(деформационные) швы';
      else if (isNaN(+constR.lenY) || +constR.lenY < 250) return '<span class="p1">Введите правильную длину</span> <br>Минимальная ДЛИНА конструкции 250 мм';
      else if (+constR.lenY > 50000) return '<span class="p1"><span class="p1">Введите правильную длину</span></span> <br>В конструкциях ДЛИНОЙ свыше 15 метров необходимо устраивать температурные(деформационные) швы';
    }
    else if (currentSubCategory == '5' && template == 201) {
      if (isNaN(+constR.lenX) || +constR.lenX < 250) return '<span class="p1">Введите правильную ширину</span> <br>Минимальная ШИРИНА конструкции 250 мм';
      else if (+constR.lenX > 50000) return '<span class="p1">Введите правильную ширину</span> <br>В конструкциях ШИРИНОЙ свыше 15 метров необходимо устраивать температурные(деформационные) швы';
      else if (isNaN(+constR.lenZ) || +constR.lenZ < 250) return '<span class="p1">Введите правильную высоту</span> <br>Минимальная ВЫСОТА конструкции 250 мм';
      else if (+constR.lenZ > 50000) return '<span class="p1"><span class="p1">Введите правильную высоту</span></span> <br>В конструкциях ВЫСОТОЙ свыше 15 метров необходимо устраивать температурные(деформационные) швы';
    }
      ...
      if (isNaN(+constR.lenX) || +constR.lenX < 200) return '<span class="p1">Введите правильную ширину</span> <br>Минимальный размер обрезанной панели ЗИПС,пригодной к монтажу,составляет 200 мм.На обрезанном фрагменте должны присутствовать минимум 2 виброузла и 2 регулиремые опоры для панелей ЗИПС-Z4';
      else if (+constR.lenX > 50000) return '<span class="p1">Введите правильную ширину</span> <br>Акустические швы в обязательном порядке устраиваются в дверных проемах,а также в местах сооружения звукоизоляционных перегородок ';
      else if (isNaN(+constR.lenY) || +constR.lenY < 200) return '<span class="p1">Введите правильную длину</span> <br>Минимальный размер обрезанной панели ЗИПС,пригодной к монтажу,составляет 200 мм.На обрезанном фрагменте должны присутствовать минимум 2 виброузла и 2 регулиремые опоры для панелей ЗИПС-Z4';
      else if (+constR.lenY > 50000) return '<span class="p1">Введите правильную длину</span> <br>Акустические швы в обязательном порядке устраиваются в дверных проемах,а также в местах сооружения звукоизоляционных перегородок';
    }
    return null;
  };
  ...
  const checkInputFloor = () => {
    if (currentSubCategory == 'F' && template != 111 && template != 3) {
      if (isNaN(+constR.lenX) || +constR.lenX < 500) return '<span class="p1">Введите правильную ширину</span> <br>Минимальная ШИРИНА конструкции 500 мм';
      else if (isNaN(+constR.lenY) || +constR.lenY < 500) return '<span class="p1">Введите правильную длину</span> <br>Минимальная ДЛИНА конструкции 500 мм';
    }
    else if (currentSubCategory == 'F' && template == 111) {
      if (isNaN(+constR.lenX) || +constR.lenX < 200) return '<span class="p1">Введите правильную ширину</span> <br>Обрезанные панели ЗИПС ШИРИНОЙ менее 200 мм не используются';
      else if (isNaN(+constR.lenY) || +constR.lenY < 200) return '<span class="p1">Введите правильную длину</span> <br>Обрезанные панели ЗИПС ДЛИНОЙ менее 200 мм не используются';
      else if (+constR.lenY > 18000) return '<span class="p1">Введите правильную длину</span> <br>Акустические швы в обязательном порядке устраиваются в дверных проемах,а также в местах сооружения звукоизоляционных перегородок';
    }
  ...
  const calcConstruction = async (constrList) => {
    try {
      ...
      console.log('Calculating construction with:', JSON.stringify(constrList, null, 2));
  ...
  const addConstrToCalc = () => {
    ...
    if (floorError) {
      ...
      if (checkInput() == null) {
        ...
        const ConstrType = SubCategories.find((el) => el.id == currentSubCategory);
  ...
  useEffect(() => {
    if (id != null) {
      ...
      if (item) {
        const subCategory = SubCategories.find((subCategory) => subCategory.id === item.c_id);
        if (subCategory) {
  ...
  console.log('Calculator rendering', { currentCategory, getActiveCategories: getActiveCategories?.length });
    ...
    <div>
      ...
      <div className="content-calc" style={{ height: "100vh" }}>
        ...
        <div className="category content-item">
          {getActiveCategories && getActiveCategories.length > 0 ? getActiveCategories.map((elem) => (
            <button
              key={elem.id}
              value={elem.id}
              style={{ background: elem.background }}
              className={currentCategory == elem.id ? 'active' : 'start_page'}
              onClick={() => setCurrentCategory(currentCategory ? 0 : elem.id)}
            >
              {elem.title}
            </button>
          )) : <div>Нет категорий</div>}
        </div>
        <div className="subcategory content-item">
          {getSubCategories && getSubCategories.length > 0 ? getSubCategories.map((elem) => (
            <button
              key={elem.id}
              value={elem.id}
              className={currentSubCategory == elem.id ? 'type_active' : 'type_page'}
              onClick={() => setCurrentSubCategory(currentSubCategory ? 0 : elem.id)}
            >
              {currentSubCategory == 0 && <img src={elem.img} alt="" className="img-icon-type" />}
              {elem.title}
            </button>
          )) : null}
        </div>
        <div className="items content-item">
          {getItems && getItems.length > 0 ? getItems.map((elem) => {
            ...
            return (
              <div key={`${elem.id}-${elem.c_id}`}>
                ...
                >
                  <p style={{ zIndex: 1, color: 'revert', pointerEvents: 'none' }}>{elem.title}</p>
                  {!isSelected && <img src={`../../../${elem.img}`} alt="" className="img-icon" />}
                </button>
                ...
                {isSelected && (
                  <>
                    ...
                    {(elem.template == 1 || elem.template == 111 || elem.template == 3 || 
                      elem.template == 607.1 || elem.template == 608.1 || elem.template == 609.1 || 
                      elem.template == 610.1 || elem.template == 2.1 || elem.template == 9 || elem.template == 9.1) && (
                      <div className="inputsFloorAll">
                        ...
                        <input
                          ...
                          value={constR.lenX || ''}
                          onChange={(e) => setConstR({ ...constR, lenX: e.target.value })}
                        />
                        <input
                          type="number"
                          placeholder="длина,мм"
                          value={constR.lenY || ''}
                          onChange={(e) => setConstR({ ...constR, lenY: e.target.value })}
                        />
                      </div>
                    )}
                      ...
                      <div className="ceiling">
                        ...
                        {elem.template == 5 && (
                          <input
                            ...
                            onChange={(e) => setConstR({ ...constR, AddCeilShift: e.target.value })}
                          />
                        )}
                      </div>
                    )}
                    ...
                    {(elem.template == 6 || elem.template == 50 || elem.template == 75 || 
                      elem.template == 100 || elem.template == 101 || elem.template == 50.1 || 
                      elem.template == 75.1 || elem.template == 100.1 || elem.template == 101.1 || 
                      elem.template == 50.2 || elem.template == 75.2 || elem.template == 100.2 || 
                      elem.template == 8.1) && (
                      <div className={elem.c_id == 'W' ? 'partittion50' : 'frame50'}>
                        <h4 style={{ margin: '5px' }}>размер конструкции</h4>
                        <input
                          type="number"
                          placeholder="ширина,мм"
                        ...
                        <input
                          ...
                          value={constR.lenZ || ''}
                          onChange={(e) => setConstR({ ...constR, lenZ: e.target.value })}
                        />
                        <button className="counter__button_param" style={{ marginBottom: '10px' }} onClick={getStartParam}>
                          изменить параметры конструкции
                        </button>
                        {unvisible && (
                          <div style={{ display: 'contents', top: '10px', marginBottom: '20px' }}>
                            <input
                              className="radio"
                              type="radio"
                              onChange={(e) => setProfileStep(e.target.value)}
                              id={`step600_${elem.id}`}
                              name={`steps_${elem.id}`}
                              value="600"
                              checked={profileStep == 600}
                            />
                            <label className="label">шаг профиля 600 мм</label>
                            <input
                              className="radio"
                              type="radio"
                              onChange={(e) => setProfileStep(e.target.value)}
                            ...
                            />
                            <label className="label">шаг профиля 400 мм</label>
                            <input
                              className="radio"
                              type="radio"
                              onChange={(e) => setProfileStep(e.target.value)}
                            ...
                            />
                            <label className="label">шаг профиля 300 мм</label>
                            <input
                              className="checkbox"
                              type="checkbox"
                              ...
                              checked={dFrame}
                            />
                            <label className="label">добавить сдвоенный каркас</label>
                            <hr />
                            ...
                            <input
                              ...
                              value={opening.lenX || ''}
                              onChange={(e) => setOpening({ ...opening, lenX: e.target.value })}
                            />
                            <input
                              type="number"
                              placeholder="высота проема,мм"
                              value={opening.lenZ || ''}
                              onChange={(e) => setOpening({ ...opening, lenZ: e.target.value })}
                            />
                            <h4 style={{ margin: '1px' }}>тип проема</h4>
                            <input
                              className="radio"
                              type="radio"
                              onChange={(e) => setOpening({ ...opening, Type: e.target.value })}
                              id={`doors_${elem.id}`}
                            ...
                            <button className="counter__button_param" style={{ right: '2px' }} onClick={addOpening}>
                              добавить проем
                            </button>
                            {constrSent.Openings.length > 0 && (
                              <div>
                                {constrSent.Openings.map((op, idx) => (
                                  <div key={idx}>
                                    {getOpeningType(op.Type)}: {op.lenX} x {op.lenZ} мм
                                    <button onClick={() => delFromOpenings(idx)}>удалить</button>
                                  </div>
                                ))}
                              </div>
                            )}
                    ...
                    {isSelected && elem.template != null && (
                      <div>
                        <button onClick={addConstrToCalc} className="counter__button_plus">
                          расчет конструкции
                        </button>
                      </div>
                    )}
        ...
        {tableConstrToCalc != null && (
          <div className="tbl-in">
            ...
            <table className="data" id="table1">
              <thead>
                <tr>
                  <th colSpan="5" style={{ fontSize: '14px', fontWeight: 'bold', textAlign: 'center' }}>
                    cписок конструкций
                  </th>
                </tr>
                <tr>
                ...
                {ConstrToCalc.map((constRItem) => (
                  <tr key={constRItem.key_id}>
                    ...
                    <td style={{ textAlign: 'center' }}>
                      {constRItem.title} ,{constRItem.lenX} x {constRItem.lenY} {constRItem.lenZ} мм
                    </td>
                ...
                {calculatedMaterials && calculatedMaterials.data && calculatedMaterials.data.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="5" style={{ textAlign: 'center', padding: '20px' }}>
                      {calculatedMaterials ? 'Нет данных для отображения' : 'Загрузка...'}
                    </td>
                  </tr>
                )}
              </tbody>
        ...
        <div>
          {template != null && (
            <button onClick={copyTableToClipboard} className="add_design_button">
              экспорт в ERP
            </button>
          )}
        </div>
